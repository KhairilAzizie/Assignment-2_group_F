...
public class OrderTransactionController {
	...
	// To insert transaction detail into database and get the auto generate transaction id
		...
		String sql	="INSERT INTO ordertransaction (TransactionDate, `Order`, AmountCharged,TransactionStatus, Last4Digits, OrderMode )VALUES (LOCALTIMESTAMP(),?, ?, ?, ?, ?);";
		...
		try{
            ...
            if(status!=0){   
                ...
                sql = "SELECT OrderTransactionId FROM ordertransaction";
